...
// únicamente se agrega el elemento a la lísta si dícho elemento NO SOBREPASA el límite establecido por el cliente:
    if(sumaUltimos2Elementos < limiteDelCliente)elementosEnlaSerieFibonacci.push(sumaUltimos2Elementos);
...
console.log(elementosEnlaSerieFibonacci);
