...
const analyzePoint = (x, y, z) => {
  if ( (x > 0 && x < 99) && (y > 0 && y < 99) ) {
    //El arreglo de imagenes se basa en que cada imagen es un arreglo de 10000 elementos, por lo que, cada fila va de 100 en 100.
    //fila 2 empezaria desde el punto 200, fila 3 desde el punto 300, etc
    if (
      // verif 
